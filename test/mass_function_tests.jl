...
@testset "integrals" begin
    ...
    @testset "RedshiftMassFunction" begin
        ...
        r1 = integrate(s1, Mmin, Mmax; npoints)
        r2 = integrate(s2, Mmin, Mmax, 0.0; npoints) 
        ...
        @test r1 ≈ integrate(s2, Mmin, Mmax, z2; npoints) - v_int atol=1e-7
        ...
        @test integrate(s3, cosmo, Mmin, Mmax, 0.0, 1.0; npoints) ≈ integrate(s1, cosmo, Mmin, Mmax, 0.0, 1.0; npoints) rtol=1e-7
    end
